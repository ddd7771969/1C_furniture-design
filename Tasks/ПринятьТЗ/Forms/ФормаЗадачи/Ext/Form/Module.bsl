...
Процедура ОбъектТЗПриИзменении(Элемент)
	НаименованиеЗадачи = "";
	Объект.Проект = ПолучитьПроектНаСервере(Объект.ОбъектТЗ, НаименованиеЗадачи);
	Объект.Наименование = НаименованиеЗадачи; 
КонецПроцедуры

&НаСервереБезКонтекста
Функция ПолучитьПроектНаСервере(ОбъектТЗ, НаименованиеЗадачи)
	
	НаименованиеЗадачи = ОбъектТЗ.Наименование + " проверить ТЗ";
