...
Функция СоздатьЗадачиПКД()
	...
	Если ТипыВнешнегоПроизводства = Неопределено
			ИЛИ НЕ ТипыВнешнегоПроизводства.ТипВнешнегоПроизводства = Перечисления.ТипыВнешнегоПроизводства.ПКД_РКД_Производство Тогда
	...
	Иначе
		КомплектыКоличество = 0;
		омВнешнееПроизводство.СоздатьЗадачуВнешнегоПроизводства(Объект.ОбъектТЗ, Объект.Проект);
	КонецЕсли;
