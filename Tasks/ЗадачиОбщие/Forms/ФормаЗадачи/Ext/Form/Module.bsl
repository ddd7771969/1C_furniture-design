...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	Если ПустаяСтрока(АдресКартинки) Тогда
		ТекущийОбъект.КартинкаЗначение 	= Неопределено;
		ТекущийОбъект.КартинкаЕсть 		= Ложь;
	Иначе
		ТекущийОбъект.КартинкаЗначение 	= Новый ХранилищеЗначения(ПолучитьИзВременногоХранилища(АдресКартинки));	
		ТекущийОбъект.КартинкаЕсть 		= Истина;
	КонецЕсли;
...
Функция ЗаписатьФайлКартинкиНаСервере() 
