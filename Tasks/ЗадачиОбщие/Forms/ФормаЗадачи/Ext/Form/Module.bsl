...
Процедура ПриОткрытии(Отказ)
	...
	ИначеЕсли Параметры.Ключ.Пустая() Тогда
		...
		Элементы.ФормаОтменить.Видимость 	= Ложь;	
		Элементы.Переадресация.Видимость	= Ложь;
		Исполнитель 						= Объект.АвторИсполнения;
		Объект.АвторИсполнения              = Неопределено;
...
Процедура ВидимостьЭлементовБегТрека()
	...
	Если НЕ ЗначениеЗаполнено(Объект.АвторИсполнения) Тогда
		Объект.АвторИсполнения = омБазаЗнанийПовтор.АвторИсполненияБэгТрека();	
	КонецЕсли;
