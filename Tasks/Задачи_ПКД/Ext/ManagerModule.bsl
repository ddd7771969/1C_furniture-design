...
Процедура СоздатьЗадачуРКД(ОбъектЗадача, Конструктор)
	...
	МенеджерРегистра = РегистрыСведений.ТаймингЗадач;
	стДанные = МенеджерРегистра.ПолучитьСтруктуруДанных(Перечисления.СостоянияЗадач.ОжиданиеКонструктором, Конструктор, Перечисления.СтатусыЗадач.РКД, ЗадачаРКД.ТипЗадачи);
