...
&НаКлиенте
Перем ПутьКФайлуПДМ, НачальноеПланРазработкиВДнях, КомментарийУвеличеияПродолжительности;
...
Процедура ПриОткрытии(Отказ)
	...
	НачальноеПланРазработкиВДнях = ПланРазработкиВДнях;
	...
	Если НЕ ТекущиеСостояние = ПредопределенноеЗначение("Перечисление.СостоянияЗадач.ОжиданиеКонструктором") Тогда
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		ПланРазработкиВДнях = ПолучитьПланРазработкиВДнях();
...
Функция ПолучитьПланРазработкиВДнях()
...
Процедура НачатьВыполнение(Команда)
	...
	Если НЕ НачальноеПланРазработкиВДнях = ПланРазработкиВДнях И ПланРазработкиВДнях > 0 Тогда
...
Процедура ПланРазработкиВДняхПриИзменении(Элемент)
	Если НачальноеПланРазработкиВДнях > 0 И НачальноеПланРазработкиВДнях < ПланРазработкиВДнях Тогда
		
		Подсказка = "Введите причину увеличения скрока";
