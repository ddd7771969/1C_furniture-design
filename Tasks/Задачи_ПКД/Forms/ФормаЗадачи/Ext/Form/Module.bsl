...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	омДлительныеОперцииНаСервере.СоздатьЭлементыИРеквизитыНаФорме(ЭтаФорма, Элементы.Группа8);
...
Процедура СбросКонструктором(Команда)
	...
	СруктураПараметров = Новый Структура("ЗадачаСсылка, НаименованиеДействия, ИмяДействияДляФайла", Объект.Ссылка, "СбросКонструктором", "");
	УИДДействия = омФайлыPDM.СоздатьДействие("СбросКонструктором", СруктураПараметров);
	ИзменитьПраваПДМ(УИДДействия, Ложь, "СбросКонструктором", СруктураПараметров)
...
Процедура ОбщаяКомандаДлительныеДействия(Команда)
	омДлительныеОперцииНаКлиента.ОбщееДействие(ЭтаФорма, ТекущийЭлемент);
КонецПроцедуры
