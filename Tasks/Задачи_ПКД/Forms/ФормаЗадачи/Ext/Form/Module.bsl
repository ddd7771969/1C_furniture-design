...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЭтаФорма.Заголовок = Строка(Объект.ОбъектТЗ) + "." + Объект.СтатусЗадачи;
...
Процедура РекламацияДизайнер(Команда)
	...
	стДанные = ДействияНаСервере("ИсправлениеДизайнер", мКомплектыДляАналогичногоДействия, Объект.Ссылка, Объект.ТипЗадачи, Объект.Исполнитель, Объект.ОбъектТЗ);
	Закрыть();
...
Функция ДействияНаСервере(Действие, Знач мКомплектыДляАналогичногоДействия, Задача, ТипЗадачи, Исполнитель = Неопределено, Параметр = Неопределено)
	...
	Задачи.Задачи_ПКД.ДействияНаСервере(Действие, мКомплектыДляАналогичногоДействия, Задача, ТипЗадачи, Исполнитель, Параметр);	
...
Процедура ВидимостьКнопок()
	...
	Элементы.ИзменениеВедущийКонструктор.Видимость 					= Объект.ДополнительноеСвойство = "Добавление комплекта"; //Был добавлен комплект в крмпозицию
