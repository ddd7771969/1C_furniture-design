&НаКлиенте
Перем мКомплектыДляАналогичногоДействия, ИзмененыСлужебныеНастройки, мТипыЗадачКонструктора, ПутьКФайлуПДМ;

&НаСервереБезКонтекста
Функция КонтрольСоответствияКонструкторов(ОбъектТЗ, КонструкторСотрудник)

	Возврат омКонструктор.ПолучитьДанныеОбъекта(ОбъектТЗ, КонструкторСотрудник).КонструкторПользователь;		
