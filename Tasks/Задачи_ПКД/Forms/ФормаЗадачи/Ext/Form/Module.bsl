...
Процедура ДоработкаВедущийКонструктор(Команда)
	...
	Если Типзнч(Объект.ОбъектТЗ) = Тип("СправочникСсылка.ИзделияКомплект") И НЕ ПредыдущийТипЗадачи = ПредопределенноеЗначение("Перечисление.ТипыЗадачКонструирования.КонтрольДизайнера") Тогда
		омФайлыPDMНаКлиенте.ВыборФайлаДляПеремещенияВPDM(Объект.Ссылка, "ДоработкаВедущийКонструктор", "Перемещение файла в каталог PDM");
	Иначе
...
Процедура ДоработкаДизайнера(Команда)
	...
	Если Типзнч(Объект.ОбъектТЗ) = Тип("СправочникСсылка.ИзделияКомплект") Тогда
		омФайлыPDMНаКлиенте.ВыборФайлаДляПеремещенияВPDM(Объект.Ссылка, "ДоработкаДизайнера", "Перемещение файла в каталог PDM");
	Иначе
...
Процедура КорректировкаДизайнер(Команда)
	...
	Если Типзнч(Объект.ОбъектТЗ) = Тип("СправочникСсылка.ИзделияКомплект") Тогда
		омФайлыPDMНаКлиенте.ВыборФайлаДляПеремещенияВPDM(Объект.Ссылка, "КорректировкаДизайнер", "Перемещение файла в каталог PDM");
	Иначе
