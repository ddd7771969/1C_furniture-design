...
Процедура СохранитьНаСервере()
	...
	ОбъектЗадача.ТипЗадачи 		= Перечисления.ТипыЗадачКонструирования.Менеджер;
	ОбъектЗадача.Исполнитель 	= Менеджер;
	ОбъектЗадача.СтатусЗадачи 	= Статус;
	ОбъектЗадача.Наименование	= омЗадачиОбщие.ПолучитьНаименованиеЗадачи(Задача, ОбъектЗадача.СтатусЗадачи, ОбъектЗадача.ОбъектЗадача);
	...
	МенеджерЗаписи = РегистрыСведений.ВнешнееДействие.СоздатьМенеджерЗаписи();
	МенеджерЗаписи.Период 			= ТекущаяДата();
	МенеджерЗаписи.Автор 			= ПараметрыСеанса.ТекущийПользователь;
	МенеджерЗаписи.Комментарий 		= Комментарий;
	МенеджерЗаписи.КонтрольнаяДата 	= КонтрольнаяДата;
