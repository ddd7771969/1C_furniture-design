...
Процедура ИспользоватьКонтактнуюИнформациюПриИзмененииНаСервере(ЗначениеФО)
	Константы.ИспользоватьКонтактнуюИнформацию.Установить(ЗначениеФО);
КонецПроцедуры

&НаКлиенте
Процедура ИспользоватьКонтактнуюИнформациюПриИзменении(Элемент)
	ИспользоватьКонтактнуюИнформациюПриИзмененииНаСервере(ЭтаФорма.НаборКонстант.ИспользоватьКонтактнуюИнформацию);
КонецПроцедуры
