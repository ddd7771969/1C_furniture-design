...
Процедура ОжиданиеГЧ(Команда)
	...
	ОткрытьФорму("Обработка.ОжиданиеГЧ.Форма",,ЭтаФорма,,,,ОповещениеПослеЗакрытияОкнаОжиданиеГЧ, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
...
Функция ПолучитьЗаголовокКнопкиОжиданиеГЧНаСервере()
	...
	Возврат "Ожидание ГЧ (" + Обработки.ОжиданиеГЧ.ЗадачиВОжиданииГЧ(Истина) + ")"	
