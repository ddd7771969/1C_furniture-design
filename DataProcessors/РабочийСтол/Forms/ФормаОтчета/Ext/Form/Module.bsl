...
Процедура КорректировкаДизайнером(Команда)
	ОткрытьФорму("Обработка.Дополнение_ТЗ_ПКД.Форма", Новый Структура("НаимеаниеДействия", "КорректировкаДизайнером"), ЭтаФорма, , , , , РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
