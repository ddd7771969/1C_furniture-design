...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если (ИмяСобытия = "ИзменениеЗамеров" ИЛИ ИмяСобытия = "ИзменениеПКД" ИЛИ ИмяСобытия = "ИзменениеРКД") И НЕ мЗамерыИнтерфейс.Найти(ТекущийИнтерфейс) = Неопределено Тогда
