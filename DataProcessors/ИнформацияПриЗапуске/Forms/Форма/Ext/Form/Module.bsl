...
Функция ПодготовитьДанныеФормы()
	...
	ПараметрыСеанса.ОграничениеДоступаНаУровнеЗаписейУниверсально = Ложь;
	ПараметрыСеанса.ОграничениеДоступаНаУровнеЗаписейИспользуется = Ложь;
	ПараметрыСеанса.СпискиСОтключеннымОграничениемЧтения = "";
	ПараметрыСеанса.ВерсииШаблоновОграниченияДоступа = ",ПоЗначениямИНаборамРасширенный18,";
