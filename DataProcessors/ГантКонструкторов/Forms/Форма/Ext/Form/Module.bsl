...
Процедура ОбновитьПроектНаСервере(ТекущийПроект)
	...
	стПараметры = Новый Структура("Диаграмма, Проект, Конструктор, Подразделение, ВыводитьПроект, Обновить, Сортировка"
		, Диаграмма, ТекущийПроект, Конструктор, Подразделение, ВыводитьПроект, Истина, Сортировка);
...
Процедура ОбновитьИсполнителяНаСервере(ТекущийИсполнитель, ТекущийПроект)
	...
	стПараметры = Новый Структура("Диаграмма, Проект, Подразделение, ВыводитьПроект, Обновит, Сортировка"
		, Диаграмма, ТекущийПроект, Подразделение, ВыводитьПроект, Истина, Сортировка);
