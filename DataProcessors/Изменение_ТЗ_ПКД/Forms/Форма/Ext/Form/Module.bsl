...
Функция ПрикрепитьФайл()
	...
	Если ПустаяСтрока(ИмяФайла) Тогда
		...
		СохранитьИнформациюВРегистр(Неопределено, ОписаниеИзменения, ОбъектТЗ);
		...
		Если ТипЗнч(Параметр) = Тип("Структура") Тогда
			...
			Если Параметр.УИД_Вызова = УИД_Вызова Тогда
				...
				Если ПустаяСтрока(Параметр.Ошибка) Тогда
					...
					СохранитьИнформациюВРегистр(стДанныеФайла, ОписаниеИзменения, ОбъектТЗ);
					Закрыть();
...
&НаСервереБезКонтекста
Процедура СохранитьИнформациюВРегистр(стДанныеФайла, ОписаниеИзменения, ОбъектТЗ)
	...
	Иначе
		...
		ДФайл = ПолучитьИзВременногоХранилища(стДанныеФайла.АдресФайла); 
		МенеджерЗаписи.ФайлТЗ 		= Новый ХранилищеЗначения(ДФайл); 
