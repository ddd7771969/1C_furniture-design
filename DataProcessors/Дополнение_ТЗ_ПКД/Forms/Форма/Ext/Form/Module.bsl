...
Процедура ОбъектТЗПриИзменении(Элемент)
	...
	Если ТипЗнч(ОбъектТЗ) = Тип("СправочникСсылка.ИзделияКомплект") Тогда 
		...
		ВидДействия = ?(ОтЗаказчика, "КорректиовкаЗаказчика", "КорректиовкаДизайнера");
		омФайлыPDMНаКлиенте.ВыборФайлаДляПеремещенияВPDM(ОбъектТЗ, ВидДействия, "Перемещение файла в каталог PDM",  "Корректиовка");
