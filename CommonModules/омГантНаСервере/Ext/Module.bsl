...
Функция ТекстЗапросаОбъеденятьВКомпозицию()
    ...
    Возврат "ВЫБРАТЬ
            ...
            |
            |СГРУППИРОВАТЬ ПО
            |	втКомплекты.Комплект.Ссылка,
            |	втКомплекты.Комплект.ОсновноеПомещение,
            |	втКомплекты.Комплект.ОсновноеПомещение.Наименование,
            ...
            |	ИзделияКомплект.Ссылка.Родитель.Композиция КАК Композиция
            |ИЗ
