...
Функция ПереместитьРеквизитВПриостановку(Реквизит, Комментарий = "") Экспорт

	УИДДоски 	= омКанбанДоскиНаСервереПовтор.ПолучитьУИДДоски("УИДДоскиПроизводство");
	УИДКудаКолонка 	= омКанбанДоскиНаСервереПовтор.ПолучитьУИДКолонки(УИДДоски, "_Приостановка_Производства");
	
	Возврат омКанбанДоскиНаСервере.ПеревестиКарточкуВПриостановку(Реквизит, УИДКудаКолонка, Комментарий);
...
Функция РесурсВПроизводстве(Ресурс, ОписанияКолонки = "") Экспорт
	...
	Если ТекущаяКолонкаУИД = омКанбанДоскиНаСервереПовтор.ПолучитьУИДКолонки(УИДДоски, "_Приостановка_Производства") Тогда
