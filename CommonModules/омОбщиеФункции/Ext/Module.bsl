...
Функция РольПолныеПраваДоступны() Экспорт

	Возврат РольДоступна("ПолныеПрава");			

КонецФункции // РольПолныеПрава()

Функция ЧислоГодаДвумяЦифрами(ГодЧислом) Экспорт
	
	Век = Цел(ГодЧислом / 100);
	Возврат ГодЧислом - Век * 100;	

КонецФункции // ЧислоГодаДвумяЦифрами()
