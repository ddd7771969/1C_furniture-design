...
Процедура ПолучитьДанныеДиаграммы(Конструктор, Подразделение, Проект, СтруктураДанныеГанта)
	...
	Запрос.Текст = 
		...
		|	И НЕ Задачи_ПКД.СтатусЗадачи = ЗНАЧЕНИЕ(Перечисление.СтатусыЗадач.ГлобальнаяПриостановкаРаботы)
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		|	И НЕ Задачи_РКД.СтатусЗадачи = ЗНАЧЕНИЕ(Перечисление.СтатусыЗадач.ГлобальнаяПриостановкаРаботы)
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
