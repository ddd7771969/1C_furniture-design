...
Функция ОбновитьГантНаСервере(стПараметры) Экспорт
	...
	ПостроитьДиаграммуГанта(стПараметры, стПромежуточныеДанные, тзЦвета);
...
Процедура ПостроитьДиаграммуГанта(стПараметры, стПромежуточныеДанные, тзЦвета)
...
Функция ВывестиТочку(Диаграмма, ДанныеТочки, тзЦвета, ТекущийЦвет = Неопределено, Обновить = Ложь)
	...
	Интервал.Конец 	= КонецДня(?(ДанныеТочки.ДатаОкончания - ДанныеТочки.ДатаНачала < СукундВСутках, ДанныеТочки.ДатаНачала + СукундВСутках, ДанныеТочки.ДатаОкончания));
