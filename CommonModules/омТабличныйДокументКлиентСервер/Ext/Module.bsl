...
Функция СформироватьОбластьТабличногоДокумента(ТабДок, стПараметры, КэшЦвета = Неопределено) Экспорт
	...
	Если КэшЦвета = Неопределено Тогда
		ЦветФона 	= ?(ТипЗнч(стПараметры.ЦветФона) 	= Тип("Цвет"), 	стПараметры.ЦветФона, 	омЦвет.ПолучитьЦветИзСтроки(стПараметры.ЦветФона));
		ЦветТекста 	= ?(ТипЗнч(стПараметры.ЦветТекста) 	= Тип("Цвет"), 	стПараметры.ЦветТекста, омЦвет.ПолучитьЦветИзСтроки(стПараметры.ЦветТекста));
		ЦветРамки   = ?(ТипЗнч(стПараметры.ЦветРамки) 	= Тип("Цвет"), 	стПараметры.ЦветРамки, 	омЦвет.ПолучитьЦветИзСтроки(стПараметры.ЦветРамки));
...
Функция ВывестиЛинию(ТабДок, стПараметры) Экспорт
	...
	Линия.ЦветЛинии = омЦвет.ПолучитьЦветИзСтроки(стПараметры.ЦветЛинииСтрокой);
