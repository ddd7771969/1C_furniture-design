...
Функция ЗаполнитьКомплектыКонструктора(Проект, Конструктор, ВПроизводстве = Истина) Экспорт
	...
	Запрос.Текст = 
		...
		|ВЫБРАТЬ
		|	Задачи_РКД.ОбъектТЗ,
		|	Задачи_РКД.ТипЗадачи = ЗНАЧЕНИЕ(Перечисление.ТипыЗадачКонструирования.ГЧОжидание)
		|ИЗ
		|	Задача.Задачи_РКД КАК Задачи_РКД
		|ГДЕ
		...
		|	втОбъекты.ОжиданиеГЧ КАК ОжиданиеГЧ
		|ИЗ
...
Функция ЗаполнитьЗадачи_РКД_ПКД(Проект, Конструктор, ВПроизводстве = Истина) Экспорт
