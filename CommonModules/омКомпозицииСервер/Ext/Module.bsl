...
Функция ПолучитьКомелектыКомпозицииБезСогласованных(Композиция) Экспорт
...
КонецФункции // ПолучитьКомелектыКомпозицииБезСогласованных()
...
Функция ПолучитьКомплектыСКонструкторами(Композиция) Экспорт
	...
	Запрос.Текст = 
		...
		|	ВЫБОР
		|		КОГДА ВЫБОР
		|				КОГДА НЕ Задачи_ПКД.Выполнена
		|					ТОГДА Задачи_ПКД.Ссылка
		|				ИНАЧЕ ВЫБОР
		|						КОГДА НЕ Задачи_РКД.Выполнена
		|							ТОГДА Задачи_РКД.Ссылка
		|						ИНАЧЕ НЕОПРЕДЕЛЕНО
		|					КОНЕЦ
		|			КОНЕЦ = НЕОПРЕДЕЛЕНО
		|			ТОГДА ЗНАЧЕНИЕ(Справочник.СтадииКомплекта.ПустаяСсылка)
		|		ИНАЧЕ ДанныеКомплектаСрезПоследних.ТекущаяСтадия
		|	КОНЕЦ КАК ТекущаяСтадия,
		...
		|				ИНАЧЕ НЕОПРЕДЕЛЕНО
		|			КОНЕЦ
		|	КОНЕЦ КАК ТекущаяЗадача,
		|	ВЫБОР
		|		КОГДА НЕ Задачи_ПКД.Выполнена
		|			ТОГДА Задачи_ПКД.ТипЗадачи
		|		ИНАЧЕ ВЫБОР
		|				КОГДА НЕ Задачи_РКД.Выполнена
		|					ТОГДА Задачи_РКД.ТипЗадачи
		|				ИНАЧЕ НЕОПРЕДЕЛЕНО
		|			КОНЕЦ
		|	КОНЕЦ КАК ТипЗадачи
		|ИЗ
...
КонецФункции // ПолучитьКомплектыСКонструкторами()
