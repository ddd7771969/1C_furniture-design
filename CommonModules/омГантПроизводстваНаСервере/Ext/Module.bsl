...
Функция ПолучитьДатаНачалаОкончания(НайденыеСтроки)
	...
	Для каждого НайденаяСтрока Из НайденыеСтроки Цикл
		...
		Если НайденаяСтрока.ДатаОкончанияПлан > стДаты.ДатаОкончания Тогда
		
			стДаты.ДатаОкончания = НайденаяСтрока.ДатаОкончанияПлан;	
...
Функция ВывестиТочку(Диаграмма, ДанныеТочки, тзЦвета, ТекущийЦвет = Неопределено, Обновить = Ложь)
	...
	Если ДанныеТочки.ЕстьРасшифровка Тогда
		Интервал.Расшифровка 	= Новый Структура("Проект, Этап, СсылкаКомплект, Продолжительность, Состояние"
		, ДанныеТочки.Проект, ДанныеТочки.Этап, ДанныеТочки.СсылкаЗначение, ДанныеТочки.Продолжительность, ДанныеТочки.Состояние);
	Иначе
