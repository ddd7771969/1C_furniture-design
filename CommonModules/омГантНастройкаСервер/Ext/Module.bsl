...
Функция ПолучитьПрефиксыГанта() Экспорт
	//Порядок не изменять!!!!!!!!
	мПрефиксыГанта = Новый Массив(4);
	мПрефиксыГанта[0] = "ЦветГанта";
	мПрефиксыГанта[1] = "РазмерШрифтаГанта";
...
Функция НеобходимоеЗначения(ТипДиаграммы = "") Экспорт
	...
	Если ТипДиаграммы = "КонтрольКонструкторы" Тогда
		мНужныеЗначения = Новый Массив(8);
		...
		мНужныеЗначения[6] = "Основное_помещение";
		мНужныеЗначения[7] = "Объект_замера";
	Иначе
...
Функция ЗаполнитьЦвета(ТипДиаграммы) Экспорт
	...
	Пока Выборка.Следующий() Цикл 
		...
		Если мПрефиксОбъект[0] = "ЦветГанта" Тогда 
			Значение = омЦветНаСервереПовтор.ПолучитьЦветИзСтрокиСПрефиксом(Выборка.Значение);	
		Иначе
