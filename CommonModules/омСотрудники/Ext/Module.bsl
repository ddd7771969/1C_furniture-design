...
Функция СотрудникиКомпозиции(Композиция, стСотрудники)
	...
	Запрос.Текст = 
		...
		|ИЗ
		|	РегистрСведений.ДанныеКомпозиции.СрезПоследних(, Композиция = &Композиция) КАК ДанныеКомпозицииСрезПоследних
		...
		|		ПО ДанныеКомпозицииСрезПоследних.Композиция = Композиции.Ссылка
		|ГДЕ
