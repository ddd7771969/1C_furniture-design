...
Функция ПолучитьИмяПапкиПриУтвержденииУдалять() Экспорт
	...
	Запрос.УстановитьПараметр("ИмяНастройки", ОбъектОтчета.НаименованиеПриУтвержденииУдалятьВПапке());
...
Функция ПолучитьЗначениеИмитацииPDM() Экспорт
	...
	Запрос.УстановитьПараметр("ИмяНастройки", ОбъектОтчета.НаименованиеИмитацияОтправкиДанныхВPDM());
...
Функция ПолучитьПриУтвержденииПереноситьИзПапки() Экспорт
	...
	Запрос.УстановитьПараметр("ИмяНастройки", ОбъектОтчета.НаименованиеПриУтвержденииПереноситьИзПапки());
