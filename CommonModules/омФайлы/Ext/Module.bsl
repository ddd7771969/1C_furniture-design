...
Функция ПолучитьПутьКФайлуТЗ(Объект, Проект = Неопределено, НаименованиКомплекта = Неопределено) Экспорт
	...
	Если ТипОбъекта = Тип("СправочникСсылка.ИзделияКомплект") Тогда
		...
		ПутьКФайлу = ПолучитьПутьКФайлуКомплектТЗ(Объект, Проект, НаименованиКомплекта);	
