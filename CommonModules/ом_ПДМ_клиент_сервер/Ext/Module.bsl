...
Функция ЗапуститьИсполнение(ТекстДок, стВозврата, ТестКаталог, ПутьКФайлуEXE, НаименованиеЭлемента, ТипВыгрузки, ЭлементВыгрузки) Экспорт
...
Функция ВыгрузитьФайлВPDM(ПутьКФайлуEXE) Экспорт
	...
	Попытка
		...
		#ИначеЕсли Сервер Тогда
			ЗапуститьПриложение(ПутьКФайлуEXE, , Истина, КодВозврата);
		#КонецЕсли				
	...
	Возврат Строка(?(КодВозврата = 0, "", "Код возврата приложения " + КодВозврата));
