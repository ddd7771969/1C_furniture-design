...
Процедура ЦветовоеОформление(обСтрока, текСтрока, стДаты, стЦвета)
	...
	Если СтрНайти(текСтрока.ОстатокМонтажа, "Ост") = 0  Тогда
	...
	Если СтрНайти(текСтрока.ЗапасТЗ, "Ост") = 0 Тогда
