...
Функция ПолучитьСтруктуруДанныхПользователя(Изменить)
	...
	Если Изменить Тогда
		стДанные = Новый Структура("Пользователь, ПутьКФайлуEXE, ПутьКФайлуЗагрузки, ПутьКФайлуEXEПроекта, ПутьКФайлуEXEКонструктор, ПутьКФайлуEXEКомпозиция, ПутьКФайлуEXEГабаритныйЧерчеж, ПутьКФайлуEXEИзменениеСтатусаГЧ, ПутьКФайлуEXEЗагрузкаТЗ, ПутьКФайлуEXEРаздатьПрава, ПутьКФайлуEXEЗабратьПрава"
		, текПользователь);
	Иначе	
		стДанные = Новый Структура("ПутьКФайлуEXE, ПутьКФайлуЗагрузки, ПутьКФайлуEXEПроекта, ПутьКФайлуEXEКонструктор, ПутьКФайлуEXEКомпозиция, ПутьКФайлуEXEГабаритныйЧерчеж, ПутьКФайлуEXEИзменениеСтатусаГЧ, ПутьКФайлуEXEЗагрузкаТЗ, ПутьКФайлуEXEРаздатьПрава, ПутьКФайлуEXEЗабратьПрава");
	КонецЕсли;
