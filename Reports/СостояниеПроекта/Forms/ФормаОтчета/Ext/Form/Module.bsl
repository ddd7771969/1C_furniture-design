...
Функция РассчитатьПоля(тзДанныеЗапрос) 
    ...
    тзДанные.Колонки.Добавить("КрайСоглосования");
	...
	Для каждого х Из тзДанныеЗапрос Цикл  
		...
		Если НЕ текущаяКомпозиция = х.Композиция И ЗначениеЗаполнено(х.Композиция) Тогда
			...
			НС.КрайСоглосования 				= х.ВнешняяДатаОкончаниеСогласованияКомпозиции;
			...
			Если (НС.ОсновнойЭтап = Перечисления.ОсновныеЭтапы.ПКД 
		...
		Если ЗначениеЗаполнено(х.Композиция) Тогда
			...
			Иначе
				...
				НС.КрайСоглосования 				= х.ВнешняяДатаОкончаниеСогласования;
			КонецЕсли;
