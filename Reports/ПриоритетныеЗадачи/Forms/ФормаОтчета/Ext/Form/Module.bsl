Процедура ПолучитьДанныеЛегенды()
	...
	Пока Выборка.Следующий() Цикл
		...
		ВебЗначениеЦветаФона = омЦветНаСервере.ПолучитьВебПредставленияЦвета(Выборка.ЦветФона, Ложь);
		ВебЗначениеЦветТекст = омЦветНаСервере.ПолучитьВебПредставленияЦвета(Выборка.ЦветТекста);
		...
		НС.ЦветФона 	= омЦветНаСервере.ПолучитьЦветИзСтрокиСПрефиксом(Выборка.ЦветФона);
		НС.ЦветТекста 	= омЦветНаСервере.ПолучитьЦветИзСтрокиСПрефиксом(Выборка.ЦветТекста);
