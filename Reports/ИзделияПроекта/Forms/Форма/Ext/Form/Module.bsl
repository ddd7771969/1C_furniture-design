...
Функция ПолучитьДанные()
	...
	тзКонтрольИзделия 	= Результат[0].Выгрузить();
	тзГЧБезКомплекта 	= Результат[1].Выгрузить();
	...
	тзИзделияЗаказчика			= РезультатЗапроса[3].Выгрузить();
