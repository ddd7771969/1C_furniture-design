...
Процедура ВывестиДанные()
	...
	Если ПолнаяПечать Тогда
		...
		стЦвета.Вставить("ПодрядПКД", 			ЦветБелый);
		стЦвета.Вставить("ПодрядРКД", 			ЦветБелый);
		стЦвета.Вставить("ПодрядПроизводства", 	ЦветБелый);
	КонецЕсли;
	...
	Для каждого х Из тзЦвета Цикл
		...
		Если ПолнаяПечать Тогда
			...
			Если х.НаименованиеЭтапа = "ПодрядПКД" Тогда
				стЦвета.Конструирование 	= х.Цвет;
			ИначеЕсли х.НаименованиеЭтапа = "ПодрядРКД" Тогда
				стЦвета.ПодрядРКД 			= х.Цвет;
			ИначеЕсли х.НаименованиеЭтапа = "ПодрядПроизводства" Тогда
				стЦвета.ПодрядПроизводства 	= х.Цвет;
	...
	Для каждого текПомещение Из тзПомещения Цикл 
		...
		Для каждого текКомплект Из НайденыеСтроки Цикл
			...
			ЭтоКомпозоция = ТипКомпозиция = ТипЗнч(текКомплект.Комплект);
			
			Если ЭтоКомпозоция Тогда
			...
			ВыводОбъекта(НайденыеСтрокиКомпозиции, текКомплект, КешЦвета, стПараметровОбласти, смещениеКолонок, стЦвета, ЭтоКомпозоция);
			...
			Если ЭтоКомпозоция Тогда
				...
				Для каждого текКомплектКомпозиции Из КомплектыКомпозиции Цикл
					...
					ВыводОбъекта(НайденыеСтрокиКомплекта, текКомплектКомпозиции, КешЦвета, стПараметровОбласти, смещениеКолонок, стЦвета, ЭтоКомпозоция, Истина);
...
&НаКлиенте
Процедура ВыводОбъекта(НайденыеСтроки, текКомплект, КешЦвета, стПараметровОбласти, смещениеКолонок, стЦвета = Неопределено, ЭтоКомпозоция = Ложь, Подчиненный = Ложь)
