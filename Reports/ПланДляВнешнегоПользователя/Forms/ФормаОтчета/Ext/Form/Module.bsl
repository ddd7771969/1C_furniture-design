...
Процедура ДиаграммаПриОкончанииРедактированияИнтервала(Элемент, Интервал, ОтменаРедактирования)
	...
	Если НЕ текЗначениеКонструирование = Неопределено Тогда
		...
		Если стДанныеДляЗаписи.Свойство("ВнешняяДатаНачалоПроектирования") И стДанныеДляЗаписи.ВнешняяДатаНачалоПроектирования = Неопределено Тогда
		...
		Если стДанныеДляЗаписи.Свойство("ВнешняяДатаОкончаниеПроектирования") И стДанныеДляЗаписи.ВнешняяДатаОкончаниеПроектирования = Неопределено Тогда
