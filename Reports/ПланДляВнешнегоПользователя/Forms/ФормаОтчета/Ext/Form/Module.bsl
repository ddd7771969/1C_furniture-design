...
Процедура ДиаграммаПриОкончанииРедактированияИнтервала(Элемент, Интервал, ОтменаРедактирования)
	...
	Если текЗначениеКонструирование = Неопределено Тогда
		...
		стДанныеДляЗаписи.ВнешняяДатаОкончаниеПроектирования 	= ПустаяДата.Конец; 
	Иначе
	...
	ИначеЕсли Этап = "РКД" Тогда
		...
		//ПолучитьСмещениеЭтапов(стДанныеДляЗаписи.ВнешняяДатаНачалоРКД, РазрывВСекундах, СекундВСутках, ДлинаКонструирования, ДлинаСогласования, ДлинаПроизводства, ДлинаМонтажа, ДлинаРКД, ДлинаТЗ, стДанныеДляЗаписи, ТипИнтервала);
...
Процедура Печать(Команда)
	ОткрытьФорму("Отчет.ПланДляВнешнегоПользователя.Форма.ФормаПечати",
		Новый Структура("Проект, МассивЗадачи, ПолнаяПечать", Проект, ПолучитьМассивДанных(Проект), Ложь));
КонецПроцедуры

&НаКлиенте
Процедура ПечатьПолная(Команда)
	ОткрытьФорму("Отчет.ПланДляВнешнегоПользователя.Форма.ФормаПечати",
		Новый Структура("Проект, МассивЗадачи, ПолнаяПечать", Проект, ПолучитьМассивДанных(Проект), Истина));
КонецПроцедуры
