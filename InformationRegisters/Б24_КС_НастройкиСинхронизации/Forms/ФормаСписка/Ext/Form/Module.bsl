...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	ОткрытьФорму("РегистрСведений.Б24_КС_НастройкиСинхронизации.Форма.ФормаЗаписи", лПараметры);
...
Процедура ВыполнитьСинхронизацию(Команда)
	...
	Если ТекущаяСтрока <> Неопределено Тогда
		...
		Если Б24_К_ОбщегоНазначенияВызовСервера.ПолучитьЗначениеРеквизитаОбъекта(ТекущаяСтрока, "ПометкаУдаления") = Ложь Тогда
			...
			ОткрытьФорму("РегистрСведений.Б24_КС_НастройкиСинхронизации.Форма.ФормаВыполнениеСинхронизации", ПараметрыФормы, , ТекущаяСтрока);
...
Функция НастройкаСинхронизацииСуществует(НастройкаПодключения)
	...
	Возврат РегистрыСведений.Б24_КС_НастройкиСинхронизации.ПолучитьМассивНастроекСинхронизации("НастройкаПодключения", НастройкаПодключения).Количество() > 0;
