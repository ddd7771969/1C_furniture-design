...
Процедура УстановитьСостояниеИсполнительЗадачи(Задача, стДанные, Комментарий = "", Смещение = 0) Экспорт
	...
	Запрос.Текст = 
	 ...
	 текТипЗадачи 	= ?(стДанные.Состояние 		= Неопределено, текТипЗадачи, 	стДанные.ТипЗадачи); 
	 ...
	 МенеджерЗаписи.Период 		= ТекущаяДата() + Смещение;
