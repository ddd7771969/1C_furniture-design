...
Функция ЗаписатьНаСервере(АдресВХ)
	...
	ЗадачаПринятьТЗ.Наименование 			= Строка(ОбъектТЗ) + " проверить ТЗ";
	ЗадачаПринятьТЗ.Дата 					= МенеджерЗаписи.ДатаСоздания;
	ЗадачаПринятьТЗ.ОбъектТЗ 				= ОбъектТЗ;
	ЗадачаПринятьТЗ.Версия 					= МенеджерЗаписи.Версия;
	ЗадачаПринятьТЗ.Проект 					= ОбъектТЗ.Проект;
	ЗадачаПринятьТЗ.Статус 					= Статус;
	ЗадачаПринятьТЗ.КрайняяДатаИсполнения 	= ЗадачаПринятьТЗ.Дата + 24 * 3600 * 3;
	ЗадачаПринятьТЗ.Исполнитель 			= омСотрудники.СотрудникиОбъекта(ОбъектТЗ).ВедущийКонструктор;
