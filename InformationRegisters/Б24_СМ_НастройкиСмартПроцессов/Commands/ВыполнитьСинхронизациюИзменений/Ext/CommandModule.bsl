...
Процедура ПослеВводаЗначения(ВыбЗнач, Параметры) Экспорт
	...
	Если ЗначениеЗаполнено(ВыбЗнач) Тогда
		...
		ОткрытьФорму("РегистрСведений.Б24_СМ_НастройкиСмартПроцессов.Форма.ФормаВыполнениеСинхронизации", ПараметрыФормы, , ВыбЗнач);
...
Функция ПолучитьКоличествоНастроекПодключенияСинхронизации()
	Возврат РегистрыСведений.Б24_СМ_НастройкиСмартПроцессов.ПолучитьКоличествоНастроекПодключенияСинхронизации();
КонецФункции

&НаСервере 
Функция ПолучитьНастройкуПодключенияПоУмолчаниюСинхронизации()
	Возврат РегистрыСведений.Б24_СМ_НастройкиСмартПроцессов.ПолучитьНастройкуПодключенияПоУмолчаниюСинхронизации();
КонецФункции
