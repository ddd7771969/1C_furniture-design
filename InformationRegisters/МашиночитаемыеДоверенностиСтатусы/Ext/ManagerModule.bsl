		...
		Для Каждого ДоверенностьДляПроверки Из ДоверенностиДляПроверкиСтатуса Цикл
			...
			Если ДоверенностьДляПроверки.ТипТранзакции = Перечисления.ТипыТранзакцийСРеестромМЧД.Регистрация Тогда
				...
				ИначеЕсли ДоверенностьДляПроверки.СтатусТранзакции = Перечисления.СтатусыТранзакцииСРеестромМЧД.Ошибка Тогда
					Если Не ИсправитьПоСпособуУстранения(ДоверенностьДляПроверки) Тогда
			...
			Если ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.Зарегистрировано
				Или ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.РегистрацияОтмены
				Или ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.Активна Тогда
				РасчетныйСтатусДокумента = Перечисления.СтатусыМЧД.Действует;
			ИначеЕсли ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.Создание
				Или ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.Подписание
				Или ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.Подписан
				Или ДоверенностьДляПроверки.ТехническийСтатус = Перечисления.ТехническиеСтатусыМЧД.Регистрация Тогда
				РасчетныйСтатусДокумента = Перечисления.СтатусыМЧД.Черновик;
			Иначе
				РасчетныйСтатусДокумента = Перечисления.СтатусыМЧД.НеДействует;
			КонецЕсли;
...
Функция ИсправитьПоСпособуУстранения(ДоверенностьДляПроверки)
	СпособУстраненияСтрокой = ДоверенностьДляПроверки.ДанныеОшибкиЗапросаСтатуса.СпособУстранения;
	...
	МетодикаИсправления = ОбщегоНазначенияКлиентСервер.СвойствоСтруктуры(СпособУстранения, "МетодикаИсправления", Неопределено);
	Если МетодикаИсправления = "ПовторнаяОтправка" Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
