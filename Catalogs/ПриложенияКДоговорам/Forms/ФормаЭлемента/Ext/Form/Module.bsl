...
Процедура ИзделияЗаказчикаИзделиеЗаказчикаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	омИзделияЗаказчикаКлиент.ОткрытьПодборИзделияЗаказчика(Объект, ЭтаФорма, Объект.Ссылка, СтандартнаяОбработка, ДополнительныеПараметры);
...
Процедура ЭлементыСделкиПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, Группа, Параметр)
	...
	омИзделияЗаказчикаКлиент.ОткрытьПодборИзделияЗаказчика(Объект, ЭтаФорма, Объект.Ссылка,,ДополнительныеПараметры);
