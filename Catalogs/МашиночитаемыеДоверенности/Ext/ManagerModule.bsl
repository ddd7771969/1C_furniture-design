...
Функция ДанныеДоверенности(Объект)
	...
	Документ = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ДокументТип"));
	...
	ОписаниеДоверенности = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ДоверенностьТип"));
...
Функция Доверенность(Объект)
	...
	Доверенность = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ДоверТип"));
...
Функция СведенияОДоверенности(Объект) // СвДовТип
	...
	СведенияОДоверенности = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвДовТип"));
...
Функция СведенияОДоверителях(Доверенность)
	...
	Для Каждого ОписаниеДоверителя Из ОписанияДоверителей Цикл
		СведенияОДоверителе = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвДоверитТип"));	
		Доверитель = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ДоверитТип"));	
		РеквизитыДоверителя = ОписаниеДоверителя.ДоверительРеквизиты.Получить();
...
Функция СведенияОДоверителеЮридическогоЛица(РеквизитыОрганизации, РеквизитыУправляющихКомпаний, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // РосОргДоверТип
	...
	СведенияОДоверителеЮридическогоЛица = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "РосОргДоверТип"));
...
Функция СведенияОФизическомЛицеДоверителе(РеквизитыФизическогоЛица, ДляНалоговыхОрганов) // ФЛДоверТип
	...
	СведенияОФизическомЛицеДоверителе = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ФЛДоверТип"));
...
Функция СведенияОЛицахДействующихОтИмениЮридическогоЛицаБезДоверенности(РеквизитыОрганизации, РеквизитыУправляющихКомпаний, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // ЛицоБезДовТип
	...
	Для Каждого РеквизитыУправляющейКомпании Из РеквизитыУправляющихКомпаний Цикл
		СведенияОЛицеДоверителя = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ЛицоБезДовТип"));
...
Функция СведенияОЕдиноличномИсполнительномОрганеУправляющейКомпании(РеквизитыУправляющейКомпании, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // СВЮЛ
	...
	СведенияОЕдиноличномИсполнительномОрганеУправляющейКомпании = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СВЮЛТип"));
...
Функция СведенияОДолжностномЛице(РеквизитыФизическогоЛица, ДляНалоговыхОрганов) // СвФЛТип
	...
	СведенияОДолжностномЛице = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвФЛТип"));
	Если ЗначениеЗаполнено(ИНН) Тогда
...
Функция СведенияОПредставителях(Доверенность) // СвУпПредТип
	...
	Для Каждого ОписаниеПредставителя Из ОписанияПредставителей Цикл
		СведенияОПредставителе = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвУпПредТип"));
		Представитель = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ПредТип"));
...
Функция СведенияОПолномочияхПредставителей(Объект) // СвПолнТип
	...
	СведенияОПолномочияхПредставителей = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвПолнТип"));
...
Функция СведенияОМашиночитаемыхПолномочиях(Объект)
	...
	Для Каждого ОписаниеПолномочия Из Объект.Полномочия Цикл
		...
		СведенияОМашиночитаемомПолномочии = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "МашПолнТип"));
...
Функция СведенияОбОграниченияхКПолномочию(Ограничения)
	...
	Для Каждого Ограничение Из Ограничения Цикл
		...
		СведенияОбОграниченииКПолномочию = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ОгрСвПолнТип"));
...
Функция СведенияОЮридическомЛице(РеквизитыОрганизации) // СвОргТип
	...
	ЭтоФилиал = РеквизитыОрганизации.ЭтоФилиал;
	
	СведенияОЮридическомЛице = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвОргТип"));	
...
Функция СведенияОбАдресе(Адрес) // АдрТип
	...
	СведенияОбАдресе = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "АдрТип"));
...
Функция СведенияОДоверителеИностранногоЮридическогоЛица(РеквизитыОрганизации, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // ИнОргДоверТип
	...
	СведенияОДоверителеИностранногоЮридическогоЛица = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ИнОргДоверТип"));
...
Функция СведенияОбИностранномЮридическомЛице(РеквизитыОрганизации) // СвИнОргТип
	...
	СведенияОбИностранномЮридическомЛице = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СвИнОргТип"));
...
Функция СведенияОбИндивидуальномПредпринимателе(РеквизитыОрганизации, РеквизитыФизическихЛиц, ДляНалоговыхОрганов) // СведИПТип
	...
	СведенияОбИндивидуальномПредпринимателе = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СведИПТип"));
...
Функция СведенияОФизическомЛице(РеквизитыФизическогоЛица, ДляНалоговыхОрганов) // СведФЛТип
	...
	СведенияОФизическомЛице = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "СведФЛТип"));
...
Функция ФИОДоверителя(РеквизитыФизическогоЛица) // ФИОТип
	...
	ФИОДоверителя = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ФИОТип"));
...
Функция СведенияОДокументеУдостоверяющемЛичность(РеквизитыФизическогоЛица) // УдЛичнФЛТип
	...
	СведенияОДокументеУдостоверяющемЛичность = ФабрикаXDTO.Создать(ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "УдЛичнФЛТип"));
...
Функция ПрочитатьИмяФайлаДоверенности(Знач ДоверенностьXML, Знач ДляНалоговыхОрганов)
	...
	ЧтениеXML.Прочитать();
	Доверенность = ФабрикаXDTO.ПрочитатьXML(ЧтениеXML, ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ДоверенностьТип"));
	ЧтениеXML.Закрыть();
...
Функция ДанныеПечати(ИсточникиДанных, КодЯзыка, ДополнительныеПараметры)
	...
	ДанныеПечати.Колонки.Добавить("ДатаВыдачи", Новый ОписаниеТипов("Дата"));
	ДанныеПечати.Колонки.Добавить("ДатаОкончания", Новый ОписаниеТипов("Дата"));
	ДанныеПечати.Колонки.Добавить("СведенияОДоверителях", Новый ОписаниеТипов("ТаблицаЗначений"));
	ДанныеПечати.Колонки.Добавить("СведенияОПредставителях", Новый ОписаниеТипов("ТаблицаЗначений"));
	ДанныеПечати.Колонки.Добавить("Полномочия", Новый ОписаниеТипов("ТаблицаЗначений"));
	
	СведенияОДоверителях = Новый ТаблицаЗначений;
	СведенияОДоверителях.Колонки.Добавить("Наименование", Новый ОписаниеТипов("Строка"));
	СведенияОДоверителях.Колонки.Добавить("ИНН", Новый ОписаниеТипов("Строка"));
	СведенияОДоверителях.Колонки.Добавить("КПП", Новый ОписаниеТипов("Строка"));
	СведенияОДоверителях.Колонки.Добавить("ОГРН", Новый ОписаниеТипов("Строка"));
	СведенияОДоверителях.Колонки.Добавить("Подписанты", Новый ОписаниеТипов("ТаблицаЗначений"));
	
	Подписанты = Новый ТаблицаЗначений;
	Подписанты.Колонки.Добавить("ФИО", Новый ОписаниеТипов("Строка"));
	Подписанты.Колонки.Добавить("Должность", Новый ОписаниеТипов("Строка"));
	Подписанты.Колонки.Добавить("ИНН", Новый ОписаниеТипов("Строка"));
	Подписанты.Колонки.Добавить("СНИЛС", Новый ОписаниеТипов("Строка"));
	Подписанты.Колонки.Добавить("СведенияОДокументеУдостоверяющемЛичность", Новый ОписаниеТипов("Строка"));
	
	СведенияОПредставителях = Новый ТаблицаЗначений;
	СведенияОПредставителях.Колонки.Добавить("ФИО", Новый ОписаниеТипов("Строка"));
	СведенияОПредставителях.Колонки.Добавить("ДатаРождения", Новый ОписаниеТипов("Строка"));
	СведенияОПредставителях.Колонки.Добавить("ИНН", Новый ОписаниеТипов("Строка"));
	СведенияОПредставителях.Колонки.Добавить("СНИЛС", Новый ОписаниеТипов("Строка"));
	СведенияОПредставителях.Колонки.Добавить("СведенияОДокументеУдостоверяющемЛичность", Новый ОписаниеТипов("Строка"));
	...
	ФайлыДоверенностей = ОбщегоНазначения.ЗначениеРеквизитаОбъектов(ИсточникиДанных, "ФайлДоверенности");
	
	Для Каждого Ссылка Из ИсточникиДанных Цикл
		ФайлыДоверенности = Новый Массив;
		ФайлДоверенности = ФайлыДоверенностей[Ссылка];
	
		Если ФайлДоверенности.Пустая() Тогда
			ФайлыДоверенностей[Ссылка] = ФайлыДоверенности;
			Продолжить;
		КонецЕсли;
		...
		ОписаниеДоверенности = ДанныеПечати.Добавить();
		ОписаниеДоверенности.Ссылка = Ссылка;
		ОписаниеДоверенности.ДатаВыдачи = Доверенность.Документ.Довер.СвДов.ДатаВыдДовер;
		ОписаниеДоверенности.ДатаОкончания = Доверенность.Документ.Довер.СвДов.СрокДейст;
		ОписаниеДоверенности.Номер = Доверенность.Документ.Довер.СвДов.НомДовер;
		ОписаниеДоверенности.СведенияОДоверителях = СведенияОДоверителях;
		ОписаниеДоверенности.СведенияОПредставителях = СведенияОПредставителях;
		ОписаниеДоверенности.Полномочия = Полномочия;
	КонецЦикла;
	...
	Для Каждого Ссылка Из Доверенности Цикл
		...
		Для Каждого СведенияОДоверителе Из СведенияОДоверителях Цикл
			...
			Если ТипДоверителя = "1" Тогда
				...
				ЕдиноличнымИсполнительнымОрганомВыступаетУправляющаяКомпания = СведенияОДоверителеЮридическогоЛица.ЕИОУК;
				ЕдиноличнымИсполнительнымОрганомВыступаетФизическоеЛицо = СведенияОДоверителеЮридическогоЛица.ЕИОФЛ;
				ЕдиноличнымИсполнительнымОрганомВыступаетИндивидуальныйПредприниматель = СведенияОДоверителеЮридическогоЛица.ЕИОИП;
		...
		ИначеЕсли ТипПолномочия = "1" Тогда
			Для Каждого СведенияОМашиночитаемомПолномочии Из СведенияОМашиночитаемыхПолномочиях Цикл
				...
				Для Каждого СведенияОбОграниченииКПолномочию Из СведенияОбОграниченияхКПолномочию Цикл
					ПорядковыйНомерОграничения = СведенияОбОграниченииКПолномочию.ИдОгр;
...
Функция ДоверенностьXDTO(ДоверенностьXML)
	
	ЧтениеXML = Новый ЧтениеXML();
	ЧтениеXML.УстановитьСтроку(ДоверенностьXML);
	ЧтениеXML.Прочитать();
	ДоверенностьXDTO = ФабрикаXDTO.ПрочитатьXML(ЧтениеXML, ФабрикаXDTO.Тип("urn://x-artefacts/EMCHD_1", "ДоверенностьТип"));
	ЧтениеXML.Закрыть();
...
Функция ПредставленияАдреса(СведенияОбАдресе)
	...
	СубъектРоссийскойФедерации = СведенияОбАдресе.Регион;
	ИдентификаторАдресаПоФИАС = СведенияОбАдресе.ИдФИАС;
...
Процедура ЗаполнитьДоверенность(Объект, ОписаниеДоверенности)
	...
	ИдентификаторФайла = ОписаниеДоверенности.ИдФайл;
	ИдентификаторФайлаДляПредставленияИнтересовВНалоговомОргане = ОписаниеДоверенности.ИдФайлНО;
	ИныеСведения = ОписаниеДоверенности.ИнСвед;
	Документ = ОписаниеДоверенности.Документ;
	
	КодФормыПоКлассификаторуНалоговойДокументации = Документ.КНД;
	...
	ВидДоверенности = СведенияОДоверенности.ВидДовер;
	ПризнакВозможностиПередоверия = СведенияОДоверенности.ПрПередов;
	ВнутреннийНомерДоверенности = СведенияОДоверенности.ВнНомДовер;
	ЕдиныйРегистрационныйНомер = СведенияОДоверенности.НомДовер;
	...
	СведенияОбИнформационнойСистеме = СведенияОДоверенности.СведСист;
