...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("Проект") Тогда 
		...
		Список.Параметры.УстановитьЗначениеПараметра("ПоказыватьПапки", Истина);
		
		Если Параметры.Свойство("ТолькоНеИспользованые") Тогда
			Если НЕ Параметры.ТолькоНеИспользованые = Неопределено И Параметры.ТолькоНеИспользованые Тогда
				Список.ТекстЗапроса = "ВЫБРАТЬ
				                      ...
				                      |	И ВЫБОР
				                      |			КОГДА &ПоказыватьПапки
				                      |				ТОГДА ИСТИНА
				                      |			ИНАЧЕ НЕ спрИзделияЗаказчика.ЭтоГруппа
				                      |		КОНЕЦ";
			...
			Список.Параметры.УстановитьЗначениеПараметра("ПоказыватьПапки", Ложь);
		КонецЕсли;
