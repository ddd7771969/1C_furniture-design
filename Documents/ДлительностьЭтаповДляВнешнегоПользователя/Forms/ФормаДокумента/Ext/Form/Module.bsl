Процедура ЗаполнитьНаСервере()
	...
	ЗаполнитьДеревоКомпозиции();
	
КонецПроцедуры 

Процедура ЗаполнитьДеревоКомпозиции()

	ДеревоКомплектовЗначение = РеквизитФормыВЗначение("ДеревоКомплектов", Тип("ДеревоЗначений")); // ДеревоЗначений
