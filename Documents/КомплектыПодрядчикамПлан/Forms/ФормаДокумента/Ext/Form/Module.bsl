...
Процедура КомплектыПриИзменении(Элемент)
	...
	Если Элемент.ТекущийЭлемент.Имя = "КомплектыРКД_Подрядчика" Тогда
		
		Если НЕ ТД.РКД_Подрядчика Тогда
			ТД.ПКД_Подрядчика = Ложь;
		КонецЕсли;
		
	ИначеЕсли Элемент.ТекущийЭлемент.Имя = "КомплектыПКД_Подрядчика" Тогда
		
		Если ТД.ПКД_Подрядчика Тогда
			ТД.РКД_Подрядчика = Истина;
		КонецЕсли;
