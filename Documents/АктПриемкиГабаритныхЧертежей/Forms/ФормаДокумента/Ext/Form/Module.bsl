...
Процедура ЗаполнитьЗадачиПроверить()
	...
	Запрос.УстановитьПараметр("СсылкаНаАкт", Объект.Ссылка);
	...
	Пока Выборка.Следующий() Цикл
		...
		НайденыеСтроки = Объект.ГабаритныеЧертежи.НайтиСтроки(Отбор);
...
Процедура ПослеЗаписи(ПараметрыЗаписи)
	КоманднаяПанель.Видимость = НЕ Объект.Проведен;	
	ЗаполнитьЗадачиПроверить();
