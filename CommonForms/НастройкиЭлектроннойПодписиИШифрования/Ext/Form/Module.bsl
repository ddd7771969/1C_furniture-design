...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.МашиночитаемыеДоверенности")
		И (Пользователи.ЭтоПолноправныйПользователь() Или ПравоДоступа("Просмотр", Метаданные.Справочники.МашиночитаемыеДоверенности)) Тогда
		Элементы.ОткрытьМашиночитаемыеДоверенности.Видимость = Истина;
		Элементы.ОткрытьМашиночитаемыеДоверенности.Заголовок = Метаданные.Справочники["МашиночитаемыеДоверенности"].Синоним;
	КонецЕсли;
