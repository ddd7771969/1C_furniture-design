...
Процедура ПриОткрытии(Отказ)
	...
	ПутьКФайлуEXEКомпозиции = ом_ПДМ_на_клиенте.ПолучитьПутьКВыгузке(ТипВыгрузки + "Композиции", стДанныеВыгрузки);
...
Процедура ВыгрузитьДанные()
	...
	Попытка
		...
		Если НЕ ПустаяСтрока(ПутьКФайлуEXE) Тогда
			...
			Иначе
				стрОшибка = омВыгрузкаCRMНаКлиенте.ВыгрузитьФайлВPDM(ПутьКФайлуEXEКомпозиции);
			КонецЕсли;
